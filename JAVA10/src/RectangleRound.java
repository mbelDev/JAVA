...
public class RectangleRound extends JFrame {
    ...
    this.addKeyListener(
        new KeyAdapter() {
          ...
          public void keyPressed(KeyEvent e) {
            ...
            if (e.getKeyCode() == KeyEvent.VK_UP) top.rotate(-angle * 5);
            if (e.getKeyCode() == KeyEvent.VK_LEFT) top.rotate(-angle);

            if (e.getKeyCode() == KeyEvent.VK_RIGHT) top.rotate(angle);
            repaint();
          }
        }
      );
